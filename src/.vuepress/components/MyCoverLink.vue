...
import { tools, LinkData } from "../data/toolData";
...
// 在这儿选择 type 对应的数据源，例如 MyCoverLink type="tool"，则映射到数据 tools（在上面 import 进来）
switch (props.type) {
  case "tool":
    linkDatas = tools;
    break;
...
.link-card {
  ...
  min-height: 10rem;
  color: inherit;
  background-image: linear-gradient(to right, #cfcfcf 0%, #434343 100%);

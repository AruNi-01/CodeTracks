import{_ as c,Z as i,$ as l,a3 as n,a1 as a,a4 as p,a2 as s,a0 as u,E as t}from"./framework-63f054a3.js";const k={},r={class:"hint-container details"},d=n("summary",null,"本文内容",-1),v={class:"table-of-contents"},m={class:"hint-container info"},b=n("p",{class:"hint-container-title"},"前言",-1),w={href:"http://aruni.me/docs/studynotes/java/concurrency/%E4%B8%BA%E4%BD%95%E6%8E%A8%E8%8D%90%E4%BD%BF%E7%94%A8%E7%BA%BF%E7%A8%8B%E6%B1%A0.html",target:"_blank",rel:"noopener noreferrer"},y=n("p",null,"我会从一个最简单的版本开始，一步步找出问题，然后提出解决思路，最后编码实现，最后完成一个基本功能完备的线程池。",-1),h=u(`<h2 id="_1-定义线程池接口" tabindex="-1"><a class="header-anchor" href="#_1-定义线程池接口" aria-hidden="true">#</a> 1. 定义线程池接口</h2><p>首先定义一个 <strong>线程池接口</strong>，向外表明该线程池提供了哪些功能，这也符合面向接口编程的思想。</p><p>一个 <strong>简单的线程池只需要具备如下几点功能</strong>：</p><ul><li>向线程池中 <strong>添加任务并执行</strong>；</li><li>设置线程池饱和时的 <strong>拒绝策略</strong>；</li><li><strong>关闭线程池</strong>。</li></ul><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
